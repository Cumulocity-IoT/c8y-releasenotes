...
Download the Cumulocity IoT Edge VM-based distribution version 10.17 from the [Cumulocity software download center](https://download.cumulocity.com/), based on the target hypervisor.
